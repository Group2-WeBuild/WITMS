                            ...
                            <form action="<?= base_url('warehouse-manager/materials/store') ?>" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <small class="text-muted">Minimum stock before reorder (must be greater than 0)</small>
                                    </div>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <small class="text-muted">Quantity to order when restocking (must be greater than 0)</small>
                                    </div>
                                </div>
