    ...
    public function run()
    {
        ...
        $users = [            
            ...
            [
                ...
                'password'           => 'AcctPayable2024!',  
                'role_id'            => $roleMap['Accounts Payable Clerk'] ?? 5,
                'department_id'      => $deptMap['Finance'] ?? 4,                
